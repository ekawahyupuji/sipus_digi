...
<head>
  ...
  <link href="<?php echo base_url();?>template/assets/img/logo.png" rel="logo-icon">
...
<body>
  ...
  <header id="header" class="fixed-top ">
    <div class="container d-flex align-items-center justify-content-between">
      <h1 class="logo">
        <img src="<?php echo base_url();?>template/assets/img/logo.png" class="img-fluid animated" alt="">
        <a href="index.html">SIPUS DIGI</a></h1>
    ...
    <div class="container-fluid" data-aos="fade-up">
      <div class="row justify-content-center">
        <div class="col-xl-5 col-lg-6 pt-3 pt-lg-0 order-2 order-lg-1 d-flex flex-column justify-content-center">
          ...
          <h2>Penujang Program Pojok Baca SMk Assa'idiyah Kudus</h2>
          <div>
            <a href="<?= base_url();?>auth/login_anggota" class="btn-get-started scrollto">Login Anggota</a>
            <a href="<?= base_url();?>auth/regristrasi" class="btn-get-started scrollto">Registrasi Anggota</a>
          </div>

        </div>
        <div class="col-xl-4 col-lg-6 order-1 order-lg-2 hero-img" data-aos="zoom-in" data-aos-delay="150">
          <img src="<?php echo base_url();?>template/assets/img/perpustakaan.jpg" class="img-fluid animated" alt="">
        </div>
      </div>
    </div>
        ...
        <div class="row">
          <div class="col-lg-6">
            <div class="info-box mb-4">
              <i class="bx bx-map"></i>
              <h3>Alamat</h3>
              <p>Ds.Mejobo Rt 06/01 Kec.Mejobo Kab.Kudus</p>
            </div>
          </div>
          ...
          <div class="col-lg-3 col-md-6">
            <div class="info-box  mb-4">
              ...
              <h3>Email Saya</h3>
              <p>ekawahyupujilestari64@gmail.com</p>
            </div>
          </div>
...
<div class="container">
  ...
  <div class="copyright-wrap d-md-flex py-4">
    <div class="me-md-auto text-center text-md-start">
      <div class="copyright">
        &copy; Copyright <strong><span>Eka Wahyu Puji Lestari</span></strong>. All Rights Reserved 2024
      </div>
      <div class="credits">
